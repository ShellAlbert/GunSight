...
ZAudioTask::~ZAudioTask()
{
    ...
    this->m_Ns2TxFIFOFree.clear();
    this->m_Ns2TxFIFOUsed.clear();
}
qint32 ZAudioTask::ZStartTask()
{
    ...
    //                                          -- tx queue --> Tcp Tx.
    this->m_capThread=new ZAudioCaptureThread(/*gGblPara.m_audio.m_capCardName*/"plughw:CARD=U0x534d0x21,DEV=0",false);
...
void ZAudioTask::ZSlotHelpThreads2Exit()
{
    ...
    {
        //notify other working threads to exit event-loop exec().
