...
ZGblPara::ZGblPara()
{
    ...
    this->m_bJsonFlushUIImg=false;//flush local UI or not.
...
void ZGblPara::readCfgFile()
{
    ...
    gGblPara.m_video.m_Cam1IDEx=iniFile.value("idex","cam1Ex").toString();
...
void ZGblPara::writeCfgFile()
{
    ...
    iniFile.setValue("id",gGblPara.m_video.m_Cam1ID);
    iniFile.setValue("idex",gGblPara.m_video.m_Cam1IDEx);
    iniFile.endGroup();
    iniFile.beginGroup("CAM2");
    ...
    iniFile.setValue("id",gGblPara.m_video.m_Cam2ID);
    iniFile.endGroup();
    iniFile.beginGroup("CAM3");
...
{
    gGblPara.m_widthCAM1=1920;
    gGblPara.m_heightCAM1=1080;
    gGblPara.m_fpsCAM1=30;
    gGblPara.m_calibrateX1=960;
    gGblPara.m_calibrateY1=540;
    gGblPara.m_video.m_Cam1ID=QString("cam1");
    gGblPara.m_video.m_Cam1IDEx=QString("cam1ex");

    gGblPara.m_widthCAM2=1920;
    gGblPara.m_heightCAM2=1080;
    gGblPara.m_fpsCAM2=30;
    gGblPara.m_calibrateX2=960;
    gGblPara.m_calibrateY2=540;
    gGblPara.m_video.m_Cam2ID=QString("cam2");
