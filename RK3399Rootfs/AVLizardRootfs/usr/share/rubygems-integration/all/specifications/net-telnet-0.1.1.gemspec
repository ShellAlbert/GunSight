...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile", "LICENSE.txt", "README.md", "Rakefile", "bin", "bin/console", "bin/setup", "debian", "lib", "lib/net", "lib/net-telnet.rb", "lib/net/telnet", "lib/net/telnet.rb", "lib/net/telnet/version.rb", "net-telnet.gemspec", "test"]
