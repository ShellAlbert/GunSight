 ...
 */
#define ARCHLIB "/usr/lib/arm-linux-gnueabihf/perl/5.26"		/**/
#define ARCHLIB_EXP "/usr/lib/arm-linux-gnueabihf/perl/5.26"		/**/
 ...
 */
#define PERL_INC_VERSION_LIST "5.26.0","5.26.0/arm-linux-gnueabihf-thread-multi-64int",0		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/arm-linux-gnueabihf/perl/5.26.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/arm-linux-gnueabihf/perl/5.26.1"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/arm-linux-gnueabihf/perl5/5.26"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/arm-linux-gnueabihf/perl5/5.26"		/**/
...
#define PERL_BUILD_DATE "Mar 10 2018 18:40:42"
#endif
