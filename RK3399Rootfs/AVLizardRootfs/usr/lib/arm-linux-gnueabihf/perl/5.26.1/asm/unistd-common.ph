...
unless(defined(&_ASM_ARM_UNISTD_COMMON_H)) {
    eval 'sub _ASM_ARM_UNISTD_COMMON_H () {1;}' unless defined(&_ASM_ARM_UNISTD_COMMON_H);
    ...
    eval 'sub __NR_statx () {( &__NR_SYSCALL_BASE + 397);}' unless defined(&__NR_statx);
}
1;
