...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Svg" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Svg_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Svg_VERSION_STRING 5.9.5)
...
macro(_populate_Svg_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Svg_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Svg)
    ...
    set(_Qt5Svg_OWN_INCLUDE_DIRS "${_qt5Svg_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Svg_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSvg")
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSvg/5.9.5"
        "${_qt5Svg_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSvg/5.9.5/QtSvg"
    )
    ...
    foreach(_module_dep ${_Qt5Svg_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.5 ${_Qt5Svg_FIND_VERSION_EXACT}
    ...
    _populate_Svg_target_properties(RELEASE "libQt5Svg.so.5.9.5" "" )
    ...
    macro(_populate_Svg_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Svg_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Svg_check_file_exists(${imported_location})
